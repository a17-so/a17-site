  ...
  return (
    <div className="min-h-screen w-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
        ...
        <h1 className="text-4xl sm:text-5xl text-zinc-100 font-medium">a17 Creator Network.</h1>
        <p className="mt-3 text-sm text-zinc-400 mt-4">Join our creator network and start earning with us.</p>
        ...
        <form onSubmit={handleSubmit} className="mt-10 space-y-6 text-zinc-300">
          ...
          <Button type="submit" size="lg" className="bg-white text-black hover:bg-white/90 h-12 rounded-full">
            Submit
          </Button>
        </form>
        ...
        <div className="mt-32 mb-8">
          <Link 
            href="https://discord.gg/a38XRpKWdD" 
            target="_blank"
